...
var.test(fem_succ$depth_adj ~ fem_succ$mated) #not equal
var.test(fem_succ$svl ~ fem_succ$mated) #equal
var.test(fem_succ$weight ~ fem_succ$mated) #equal
var.test(fem_succ$snout_adj ~ fem_succ$mated) #equal

normalTest(fem_succ$length, method = "da") #normal
normalTest(fem_succ$depth_adj, method = "da") #not normal
normalTest(fem_succ$svl, method = "da") #normal
normalTest(fem_succ$weight, method = "da") #normal
normalTest(fem_succ$snout_adj, method = "da") #not normal

t.test(fem_succ$length ~ fem_succ$mated, 
       var.equal = TRUE)
wilcox.test(fem_succ$depth_adj ~ fem_succ$mated)
t.test(fem_succ$svl ~ fem_succ$mated, 
       var.equal = TRUE)
t.test(fem_succ$weight ~ fem_succ$mated, 
       var.equal = TRUE)
wilcox.test(fem_succ$snout_len ~ fem_succ$mated)
```
