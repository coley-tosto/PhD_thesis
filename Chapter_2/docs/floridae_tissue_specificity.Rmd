...
#Liver
top_liver <- liver_bias_tau_all[sqrt(abs(liver_bias_tau_all$log2FoldChange)) > 4 & liver_bias_tau_all$tau > 0.75, ]
...
#Plot logFC against Tau for all of the organs
plot(sqrt(abs(gonad_bias_tau_all_gonads$log2FoldChange)),
     gonad_bias_tau_all_gonads$tau,
     pch=19,
     col = "#EEB42275",
     xlab="sex bias (|log2 fold change|)",
     ylab=expression(tau["TPM"]),
...
#Add the best fit lines
abline(lm(gonad_bias_tau_all_gonads$tau ~ sqrt(abs(gonad_bias_tau_all_gonads$log2FoldChange))), 
       col="#EEB422", lwd = 3)
