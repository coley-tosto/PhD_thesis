...
t.test(fem_meso$length, mal_meso$length, var.equal = TRUE)
wilcox.test(fem_meso$length, mal_meso$length)
t.test(fem_meso$depth, mal_meso$depth, var.equal = FALSE)
...
```{r}
fem_depth_adj <- fem_meso$depth/fem_meso$svl
mal_depth_adj <- mal_meso$depth/mal_meso$svl
