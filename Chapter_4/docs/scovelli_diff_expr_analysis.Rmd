...
#write.table(cbind(rownames(SS_sex_specific_genes$Gonad_female_specific)),
 ...
 #           row.names = FALSE, 
 #           col.names = FALSE)
#write.table(cbind(rownames(SS_sex_specific_genes$Liver_male_specific)),
 #           'data/SS_malL_specific_TRgenes.txt', 
 #           sep = "", 
 #           quote=FALSE, 
 #           row.names = FALSE, 
 #           col.names = FALSE)
...
barplot(bias_cat_brain[,biased_bins[biased_bins!="Unbiased"]], 
        beside = TRUE, 
        ylim = c(0, max(bias_cat_brain) + 1), 
        col = c("#7fc97f", "#beaed4"),
        main = "Brain")

barplot(bias_cat_gonad[,biased_bins[biased_bins!="Unbiased"]], 
        beside = TRUE, 
        ylim = c(0, max(bias_cat_gonad) + 1), 
        col = c("#7fc97f", "#beaed4"),
        main = "Gonad")
