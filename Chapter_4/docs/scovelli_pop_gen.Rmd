...
logFC <- read.csv("data/logFC_long_sexbias.csv")
...
pairwise.wilcox.test(logFC_TD[logFC_TD$tissue == "Skin", ]$Tajima, logFC_TD[logFC_TD$tissue == "Skin", ]$bias, p.adjust.method = "holm")
